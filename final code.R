...
t1<-t1[-1,]
t1<-as.data.frame(t1)
plot(year,t1$`0-4`,type = 'l',ylab = "mortality rate",main = "Age 0-4")
#plot(year,t1$`20-24`,type = 'l',ylab = "mortality rate",main = "Age 20-24")
plot(year,t1$`40-44`,type = 'l',ylab = "mortality rate",main = "Age 40-44")
#plot(year,t1$`60-64`,type = 'l',ylab = "mortality rate",main = "Age 60-64")
plot(year,t1$`80-84`,type = 'l',ylab = "mortality rate",main = "Age 80-84")
#plot(year,t1$`90+`,type = 'l',ylab = "mortality rate",main = "Age 90+")

par(mar=c(5,7,5,7))
par(mgp=c(3,1,0))
plot(year,t1$`0-4`,type = 'l',ylab = "mortality rate",main = "Mortality Rate of Partial Age Groups",ylim=c(0,0.3),col=mondrian_colors[1] )
...
t2<-t2[-1,]
t2<-as.data.frame(t2)
plot(year,t2$`0-4`,type = 'l',ylab = "mortality rate",main = "Age 0-4")
plot(year,t2$`20-24`,type = 'l',ylab = "mortality rate",main = "Age 20-24")
plot(year,t2$`40-44`,type = 'l',ylab = "mortality rate",main = "Age 40-44")
plot(year,t2$`60-64`,type = 'l',ylab = "mortality rate",main = "Age 60-64")
plot(year,t2$`80-84`,type = 'l',ylab = "mortality rate",main = "Age 80-84")
plot(year,t2$`90+`,type = 'l',ylab = "mortality rate",main = "Age 90+")

par(mar=c(5,7,5,7))
par(mgp=c(3,1,0))
plot(year,t2$`0-4`,type = 'l',ylab = "mortality rate",main = "Mortality Rate of Partial Age Groups",ylim=c(0,0.3),col=mondrian_colors[11] )
...
plot(am,type="l",lwd=2,col="red",ylim=c(-9,0),ylab="ax",xaxt="n")
...
age1<-c(0,20,40,60,80)
plot(bm,type="l",lwd=2,col="red",ylim=c(0,0.15),ylab="bx",xaxt="n")
axis(1, at = age1, labels = c("0-4", "20-24", "40-44", "60-64", "80-84"))
...
plot(km,type="l",lwd=2,col="red",ylim=c(-20,15),ylab="kt")
...
plot(x=mlca$age, y=log(mlca$male[,1]), type="l", lty=1,
     main="Observed vs fitted Lee Carter Model - 2003 and 2021 Male Mortality",)
...
plot(x=flca$age, y=log(flca$female[,1]), type="l", lty=1,
     main="Observed vs fitted Lee Carter Model - 2003 and 2021 Female Mortality",)
lines(flca$age, y=flca$fitted$y[,1],
      col=1, lty=2)
legend("top", legend=c("Obs 2", "Pred 2021"), col=c(1,1,3,3), lty=c(1,2,1,2))

#预测未来的死亡率
mforecast_lc <- forecast(mlca, h = 10)
fforecast_lc <- forecast(flca, h = 10)
par(mfrow=c(1,2))
plot(mdata,years=1999:2021,ages = 0:90, main="Males - Ages 0 - 90+ (1999-2021)")
plot(forecast(mlca,h=20,jumpchoice="fit"),ylim=c(-11,0) )

plot(fdata,years=1999:2021,ages = 0:90, main="Females - Ages 0 - 90+ (1999-2021)")
plot(forecast(flca,h=20,jumpchoice="fit"),ylim=c(-14,0) )
